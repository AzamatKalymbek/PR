...
// kmean with starting data (14 dimensional)
// k-mean algorithm
...
public class KMean {
    ...
    public static void main(String[] args) {
        startKMeanAlgorithm(null, false);
    }

    /**
     *  With Fixed centers
     * */
    public static List<HashMap<String, Object>> startKMeanAlgorithm(List<Data> zeroList, Boolean viaNearestNeighbor) {
        zeroLists = zeroList;
...
//                DisplayFunctions.printDistance(distanceList);
     ...
     *  With Random centers
     * */
    public static List<HashMap<String, Object>> kMeanAlgorithm(Integer classSize) {
        clusters = new ArrayList<>();
